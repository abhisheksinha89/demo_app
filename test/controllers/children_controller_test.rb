...
class ChildrenControllerTest < ActionController::TestCase
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post :create, child: { address: @child.address, gender: @child.gender, name: @child.name, school: @child.school }
    end
  ...
  test "should update child" do
    patch :update, id: @child, child: { address: @child.address, gender: @child.gender, name: @child.name, school: @child.school }
    assert_redirected_to child_path(assigns(:child))
  end
